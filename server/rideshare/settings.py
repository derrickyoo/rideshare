...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", default="CHANGE_ME!")
...
INSTALLED_APPS = [
    ...
    "rest_framework",
    # Local
    "rideshare.users.apps.UsersConfig",
    "rideshare.trips.apps.TripsConfig",
]
...
STATIC_ROOT = os.path.join(BASE_DIR, "/usr/src/app/static")
